...
export const Route = createFileRoute('/app/')({ component: PhaseZeroRoute })
    ...
    <main className="min-h-screen bg-neutral-50 px-5 py-8">
      <div className="mx-auto max-w-5xl space-y-7">
        ...
        <section className="rounded-2xl border bg-white p-6 shadow-sm">
          <label className="block cursor-pointer rounded-xl border-2 border-dashed border-neutral-300 p-8 text-center hover:border-neutral-500">
        ...
        <section className="space-y-4">
          ...
          {results.length === 0 && (
            <p className="rounded-xl border bg-white p-6 text-sm text-neutral-500">
